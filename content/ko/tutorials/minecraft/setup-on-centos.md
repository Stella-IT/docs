...
마인크래프트 서버 버전에 맞는 Java를 설치해야 합니다. [Java 버전 호환성 가이드](/tutorials/minecraft/java-version-compatibility)에서 필요한 버전을 확인한 뒤 [Fedora, Rocky Linux 및 RHEL 계열 설치 방법](/tutorials/minecraft/install-guide/java#fedora-rocky-linux-및-rhel-계열)을 따라 설치하세요.
