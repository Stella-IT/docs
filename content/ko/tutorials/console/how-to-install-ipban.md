...
<img width="456" height="294" alt="CleanShot 2026-07-20 at 15 10 00" src="https://github.com/user-attachments/assets/cba3472f-0b3f-4996-9567-7b46031ca303" />

2. `계정 정책` → `계정 잠금 정책` 으로 이동합니다.
3. `계정 잠금 임계값` 을 `999` (사실상 무제한)로 변경합니다.
<img width="922" height="647" alt="CleanShot 2026-07-20 at 15 10 37" src="https://github.com/user-attachments/assets/075b94a8-0af6-4875-b616-95e2a4e9022f" />

4. 변경 사항을 적용(재부팅)하고 RDP를 다시 시도합니다.
