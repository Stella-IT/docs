...
중도 해지가 필요한 경우, [Stella IT Console 지원](https://console.stella-it.cloud/support) 섹션에 접속하신 후 `지원코드 발급`을 이용하여 지원코드를 발급받으신 후, 위에 '상담원을 통한 지원' 중 한 가지를 선택하셔서 발급하신 지원코드 및 삭제를 원하시는 가상 머신을 말씀해 주세요.  
...
<alert type="warning">
환불 받을 수 있는 금액이 0원 이하인 경우, 환불이 진행되지 않습니다.
</alert>
