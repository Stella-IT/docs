...
<alert type="info">
  공인 IP 서비스를 사용 할 수 있는 클러스터 (yeouido-highend-02, yeouido-highend-03) 의 VM을 구매하는 경우, 해당 서비스를 Stella IT의 DDoS 방어 서비스를 이용해 보호하지는 못하지만, 공인 IP 를 통해 서비스 추가 가입을 통해 서버를 열 수 있습니다.  
