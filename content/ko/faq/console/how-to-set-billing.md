...
자동 결제 기능은 Stella IT에서 생성한 가상 머신이 만료되기 5일 전에 미리 등록해둔 카드 또는 간편 결제 수단으로 자동 연장하는 편리한 기능입니다.
...
2. [인스턴스](https://console.stella-it.com/vm) 탭을 클릭합니다.
3. 자동 결제 활성화하고자 하는 인스턴스을 클릭합니다.
